  ...
  return (
    <View style={styles.safe}>
      ...
      <Modal visible={showMenuDialog1} transparent animationType="fade" onRequestClose={() => setShowMenuDialog1(false)}>
        <Pressable style={styles.modalOverlay} onPress={() => setShowMenuDialog1(false)}>
          <Pressable style={styles.modalCard} onPress={() => {}}>
              ...
              {draft.vsVirtual ? (
                <>
                  ...
                  <TextInput
                    ...
                    placeholder={draft.virtualSide === 0 ? 'PL.2' : 'PL.1'}
            ...
            <View style={styles.modalBtnsSingle}>
              <Pressable style={[styles.modalBtn, styles.modalBtnOk, styles.modalBtnArrow]} onPress={applySetupStep1}>
                <Text style={styles.modalBtnArrowText}>→</Text>
              </Pressable>
            </View>
...
const styles = StyleSheet.create({
  ...
  modalBtnArrow: { minWidth: 72, alignSelf: 'flex-end', flexGrow: 0 },
  modalBtnArrowText: { fontWeight: '900', color: '#ffffff', fontSize: 24, lineHeight: 24 },
